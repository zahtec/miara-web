...
<Banner
	...
	class="from-rose-950 to-rose-700"
	icon={DocumentIcon}
/>

<PageContent class="flex flex-col gap-5">
	<UpdateNotice class="bg-rose-800 border-rose-600" />

	<p>
		We are Miara, doing business as Miara ("<strong>Company</strong>," "<strong>we</strong>," "<strong
			>us</strong
		>," "<strong>our</strong>"), a company registered in California, United States.
	</p>

	<p>
		We operate the website <a href="https://miara.app">https://miara.app</a> (the "<strong
			>Site</strong
		>"), the mobile application Miara (the "<strong>App</strong>"), as well as any other related
	...
	<p>
		Miara is a platform that provides individuals an intuitive method of searching for and applying
		to homelessness services. Users can manage their applications, view their status, and save
		services for later.
	</p>

	<p>You can contact us by email at <a href="mailto:support@miara.app">support@miara.app</a>.</p>

	<p>
		These Legal Terms constitute a legally binding agreement made between you, whether personally or
		on behalf of an entity ("<strong>you</strong>"), and Miara, concerning your access to and use of
		the Services. You agree that by accessing the Services, you have read, understood, and agreed to
		be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN
	...
	<p>
		...
		18) must have the permission of, and be directly supervised by, their parent or guardian to use
		the Services. If you are a minor, you must have your parent or guardian read and agree to these
	...
	<ol class="!ml-7">
		...
		<li>
			<a href="#urep">User Representations.</a>
		</li>
		<li>
			<a href="#ureg">User Registration.</a>
		</li>
		<li>
			<a href="#p">Prohibited Activities.</a>
		</li>
		<li>
			<a href="#ugc">User Generated Contributions.</a>
		</li>
		<li>
			<a href="#cl">Contribution License.</a>
		</li>
		<li>
			<a href="#m">Mobile Applicatio License.</a>
		</li>
		<li>
			<a href="#tp">Third-Party Websites and Content.</a>
		</li>
		<li>
			<a href="#sm">Services Management.</a>
		</li>
		<li>
			<a href="#pp">Privacy Policy.</a>
		</li>
		<li>
			<a href="#ci">Copright Infringements.</a>
		</li>
		<li>
			<a href="#t">Term and Termination.</a>
		</li>
		<li>
			<a href="#m">Modifications and Interruptions.</a>
		</li>
		<li>
			<a href="#l">Governing Law.</a>
		</li>
		<li>
			<a href="#d">Dispute Resolution.</a>
		</li>
		<li>
			<a href="#c">Corrections.</a>
		</li>
		<li>
			<a href="#d">Disclaimer.</a>
		</li>
		<li>
			<a href="#ll">Limitations of Liability.</a>
		</li>
		<li>
			<a href="#i">Indemnification.</a>
		</li>
		<li>
			<a href="#ud">User Data.</a>
		</li>
		<li>
			<a href="#e">Electronic Communications, Transactions, and Signatures.</a>
		</li>
		<li>
			<a href="#ca">California Users and Residents.</a>
		</li>
		<li>
	...
	<h1 class="font-bold" id="s">1. Our Services.</h1>
	...
	<p>
		Miara demonstrates adherence to the Health Insurance Portability and Accountability Act (HIPAA)
		by safeguarding sensitive medical information in accordance with the Act. All identifiable
		health information (PHI) defined by HIPAA is protected through robust security measures to
		prevent unauthorized access, disclosure, or misuse. This includes secure storage practices and
		encryption of data at rest and in transit. User consent is also required for any disclosure of
		PHI, except in specific, permitted situations outlined by HIPAA. Miara's Privacy Policy,
		publicly available at <a href="https://miara.app/privacy">https://miara.app/privacy</a>, clearly
		and transparently outlines its practices for collecting, using, and sharing user data, including
		PHI. As outlined in Miara's Privacy Policy, users have the right to access, correct, and delete
		their PHI as permitted by HIPAA and the California Consumer Privacy Act (CCPA).
	</p>

	<h1 class="font-bold" id="ip">2. Intellectual Property Rights.</h1>

	<h1 class="font-semibold">Our intellectual property.</h1>
	...
	<h1 class="font-semibold">Your use of our Services.</h1>

	<p>
		Subject to your compliance with these Legal Terms, including the "<a href="#p"
	...
	<p>
		...
		section or elsewhere in our Legal Terms, please address your request to: <a
	...
	<h1 class="font-semibold">Your submissions and contributions.</h1>

	<p>
		Please review this section and the "<a href="#p">Prohibited Activities</a>" section carefully
	...
	<p>
		<storng>Submissions:</storng> By directly sending us any question, comment, suggestion, idea, feedback,
		...
		its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment
		or compensation to you.
	</p>

	<p>
		<strong>Contributions:</strong> The Services may invite you to chat, contribute to, or participate
	...
	<p>
		<strong
			...
			and logos):
		</strong> By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual,
	...
	<p>
		...
		posting Contributions through any part of the Services or making Contributions accessible through
		the Services by linking your account through the Services to any of your social networking accounts,
		you:
	</p>

	<ul>
		<li>
			confirm that you have read and agree with our "<a href="#p">Prohibited Activities</a>" and
			will not post, send, publish, upload, or transmit through the Services any Submission nor post
			any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying,
	...
	<p>
		...
		if in our reasonable opinion we consider such Contributions harmful or in breach of these Legal Terms.
		If we remove or edit any such Contributions, we may also suspend or disable your account and report
		you to the authorities.
	</p>

	<h1 class="font-semibold">Copyright infringement.</h1>

	<p>
		We respect the intellectual property rights of others. If you believe that any material
		available on or through the Services infringes upon any copyright you own or control, please
		immediately refer to the "<a href="#ci">Copright Infringements</a>" section below.
	</p>

	<h1 class="font-bold" id="urep">3. User Representations.</h1>
	...
	<p>
		...
		jurisdiction in which you reside, or if a minor, you have received parental permission to use
		the Services; (5) you will not access the Services through automated or non-human means, whether
	...
	<h1 class="font-bold" id="ureg">4. User Registration.</h1>
	...
	<h1 class="font-bold" id="p">5. Prohibited Activities.</h1>
	...
	<ul>
		...
		<li>
			Copy or adapt the Services' software, including but not limited to CSS, HTML, JavaScript,
			TypeScript, or other code.
		</li>
		<li>
		...
		<li>
			Utilize contact information found on the Services for malicious or unauthorized purposes,
			including but nto limited to advertising, scams, or spam.
		</li>
		<li>Intentionally send excessive network requests to the Services for any purpose.</li>
	</ul>

	<h1 class="font-bold" id="ugc">6. User Generated Contributions.</h1>
	...
	<h1 class="font-bold" id="cl">7. Contribution License.</h1>
	...
	<h1 class="font-bold" id="m">8. Mobile Application License.</h1>

	<h1 class="font-semibold">Use License.</h1>

	<p>
		If you access the Services via the App, then we grant you a revocable, non-exclusive,
		non-transferable, limited right to install and use the App on wireless electronic devices owned
		or controlled by you, and to access and use the App on such devices strictly in accordance with
	...
	<h1 class="font-semibold">Apple and Android Devices.</h1>
	...
	<p>
		...
		App is limited to a non-transferable license to use the application on a device that utilizes
		...
		agreement when using the App, e.g., if you have a VoIP application, then you must not be in
		...
		this mobile application license contained in these Legal Terms, and that each App Distributor
	...
	<h1 class="font-bold" id="tp">9. Third-Party Websites and Content.</h1>
	...
	<p>
		...
		music, sound, video, information, applications, software, and other content or items belonging
		to or originating from third parties ("Third-Party Content"). Such Third-Party Websites and
		...
		Websites or any Third-Party Content does not imply approval or endorsement thereof by us. If you
		...
		on Third-Party Websites and you shall hold us blameless from any harm caused by your purchase of
		such products or services. Additionally, you shall hold us blameless from any losses sustained
	...
	<h1 class="font-bold" id="sm">10. Services Management.</h1>
	...
	<h1 class="font-bold" id="pp">11. Privacy Policy.</h1>

	<p>
		We care about data privacy and security. Please review our Privacy Policy: <a
			href="https://miara.app/privacy">https://miara.app/privacy</a
	...
	<h1 class="font-bold" id="ci">12. Copyright Infringements.</h1>
	...
	<h1 class="font-bold" id="t">13. Term and Termination.</h1>
	...
	<h1 class="font-bold" id="m">14. Modifications and Interruptions.</h1>
	...
	<h1 class="font-bold" id="l">15. Governing Law.</h1>
	...
	<h1 class="font-bold" id="d">16. Dispute Resolution.</h1>

	<h1 class="font-semibold">Informal Negotiations.</h1>
	...
	<p>
		...
		us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt
	...
	<h1 class="font-semibold">Binding Arbitration.</h1>
	...
	<p>
		...
		binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE
		...
		Rules"), both of which are available at the <a href="https://adr.org"
		...
		conducted in person, through the submission of documents, by phone, or online. The arbitrator
		...
		applicable law, the arbitration will take place in Santa Cruz County, California. Except as
	...
	<p>
		...
		commenced or prosecuted in the state and federal courts located in Santa Cruz County,
	...
	<h1 class="font-semibold">Restrictions.</h1>
	...
	<h1 class="font-semibold">Exceptions to Informal Negotiations and Arbitration.</h1>
	...
	<h1 class="font-bold" id="c">17. Corrections.</h1>
	...
	<h1 class="font-bold" id="d">18. Disclaimer.</h1>
	...
	<h1 class="font-bold" id="ll">19. Limitations of Liability.</h1>
	...
	<p>
		...
		REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO $2,500.00 USD. CERTAIN US
	...
	<h1 class="font-bold" id="i">20. Indemnification.</h1>
	...
	<p>
		...
		any third party due to or arising out of: (1) your Contributions; (2) use of the Services; (3)
		breach of these Legal Terms; (4) any breach of your representations and warranties set forth in
		these Legal Terms; (5) your violation of the rights of a third party, including but not limited
		to intellectual property rights; or (6) any overt harmful act toward any other user of the
	...
	<h1 class="font-bold" id="ud">21. User Data.</h1>
	...
	<h1 class="font-bold" id="e">22. Electronic Communications, Transactions, and Signatures.</h1>
	...
	<h1 class="font-bold" id="ca">23. California Users and Residents.</h1>
	...
	<h1 class="font-bold" id="misc">24. Miscellaneous.</h1>
	...
	<h1 class="font-bold" id="cu">25. Contact Us.</h1>

	<p>
		In order to resolve a complaint regarding the Services or to receive further information
		regarding use of the Services, please contact us at <a href="mailto:support@miara.app"
			>support@miara.app</a
		>.
	</p>
</PageContent>
